...
print_to_csv <- function(filename, timestep, personal_indicies, process, categories) {
    invisible(.Call(`_malariasimulation_print_to_csv`, filename, timestep, personal_indicies, process, categories))
}
