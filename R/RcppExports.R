...
create_adult_mosquito_model <- function(growth_model, mu, tau, susceptible, foim, lsm_factor) {
    .Call(`_malariasimulation_create_adult_mosquito_model`, growth_model, mu, tau, susceptible, foim, lsm_factor)
}

adult_mosquito_model_update <- function(model, mu, foim, lsm_factor, susceptible, f) {
    invisible(.Call(`_malariasimulation_adult_mosquito_model_update`, model, mu, foim, lsm_factor, susceptible, f))
}
