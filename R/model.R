...
#' prevalence_rendering_min_ages and prevalence_rendering_max_ages parameters.
#'  * n_true: number of humans with an infection between an inclusive age range at this timestep. True
#'  prevalence columns can be set with true_prevalence_rendering_min_ages and 
#'  true_prevalence_rendering_min_ages parameters.
