...
#'
#' feeding cycle:
#' please set vector control strategies using `set_betnets`, `set_spraying` and `set_semiochemical`
#'
...
#' * chemical_timesteps - to enable a reduced foraging time to be implemented as required; default = NULL
#'
