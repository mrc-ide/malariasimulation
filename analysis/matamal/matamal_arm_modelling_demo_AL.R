...
#this is 19% (closest can get to target prev)
cali_EIR # 5.10...
...
ggplot(run_control, aes(x = timestep, y = n_detect_pcr_0_31025/n_age_0_31025))+
  geom_line()+
  #2019 survey
  geom_point(data = prev_2018, aes(day, y = mean_prev), col = "red", shape = 4, 
             inherit.aes = FALSE)+
...
control_plot <- ggplot(run_control, aes(x = (timestep/365)+2011, y = (n_detect_pcr_0_31025/n_age_0_31025)))+
  ...
  #2019 survey
  geom_point(data = prev_2018, aes(x = (day/365)+2011, y = mean_prev), col = "red", shape = 4, 
             inherit.aes = FALSE)+
  geom_errorbar(data = prev_2018,
                aes(x = (day/365)+2011, ymin = lower_prev/100, ymax = upper_prev/100),
                color = "red", width = 0.2,
                inherit.aes = FALSE)+
  #2021 survey
