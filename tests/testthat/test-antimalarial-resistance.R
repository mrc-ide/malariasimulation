...
test_that('set_antimalarial_resistance() assigns parameters correctly despite order in which resistance parameters are specified', {
  ...
  expect_identical(unlist(parameters$artemisinin_resistance_prop), c(0.5, 0, 0.27))
  expect_identical(unlist(parameters$partner_drug_resistance_prop), c(0, 0, 0))
  ...
  expect_identical(unlist(parameters$reinfection_during_prophylaxis_prob), c(0, 0, 0))
...
test_that('get_antimalarial_resistance_parameters() correctly retrieves parameters when multiple drugs assigned', {
  ...
  expected_resistance_parameters$artemisinin_resistance_prop <- c(0.1, 0.03, 0.2, 0.1, 0.2, 0.03, 0.03, 0.03, 0.2, 0.1, 0.03, 0.1, 0.2, 0.03, 0.2)
  expected_resistance_parameters$partner_drug_resistance_prop <- rep(0, 15)
  expected_resistance_parameters$slow_parasite_clearance_prob <- c(0.1, 0.03, 0.2, 0.1, 0.2, 0.03, 0.03, 0.03, 0.2, 0.1, 0.03, 0.1, 0.2, 0.03, 0.2)
  expected_resistance_parameters$early_treatment_failure_prob <- c(0.1, 0.03, 0.2, 0.1, 0.2, 0.03, 0.03, 0.03, 0.2, 0.1, 0.03, 0.1, 0.2, 0.03, 0.2)
  expected_resistance_parameters$late_clinical_failure_prob <- rep(0, 15)
  expected_resistance_parameters$late_parasitological_failure_prob <- rep(0, 15)
  expected_resistance_parameters$reinfection_during_prophylaxis_prob <- rep(0, 15)
...
test_that('get_antimalarial_resistance_parameters() correctly retrieves parameters when not all drugs assigned resistance', {
  ...
  expected_resistance_parameters <- list()
  expected_resistance_parameters$artemisinin_resistance_prop <- c(0, 0, 0.2, 0, 0.2, 0, 0, 0, 0.2, 0, 0, 0, 0.2, 0, 0.2)
  expected_resistance_parameters$partner_drug_resistance_prop <- rep(0, 15)
  expected_resistance_parameters$slow_parasite_clearance_prob <- c(0, 0, 0.2, 0, 0.2, 0, 0, 0, 0.2, 0, 0, 0, 0.2, 0, 0.2)
  expected_resistance_parameters$early_treatment_failure_prob <- c(0, 0, 0.2, 0, 0.2, 0, 0, 0, 0.2, 0, 0, 0, 0.2, 0, 0.2)
  expected_resistance_parameters$late_clinical_failure_prob <- rep(0, 15)
  expected_resistance_parameters$late_parasitological_failure_prob <- rep(0, 15)
  expected_resistance_parameters$reinfection_during_prophylaxis_prob <- rep(0, 15)
