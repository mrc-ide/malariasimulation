test_that('1 correlation between rounds gives sensible samples', {
  ...
  round_1 <- sample_intervention('rtss', pop, parameters$rtss_coverage, c_param)
  round_2 <- sample_intervention('rtss', pop, parameters$rtss_coverage, c_param)
...
test_that('1 correlation between interventions gives sensible samples', {
  ...
  rtss_sample <- sample_intervention('rtss', pop, parameters$rtss_coverage, c_param)
  mda_sample <- sample_intervention('mda', pop, parameters$mda_coverage, c_param)
