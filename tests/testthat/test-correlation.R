test_that('1 correlation between rounds gives sensible samples', {
  ...
  round_1 <- sample_intervention(target, 'rtss', rtss_coverage, correlations)
  round_2 <- sample_intervention(target, 'rtss', rtss_coverage, correlations)
...
test_that('1 correlation between interventions gives sensible samples', {
  ...
  rtss_sample <- sample_intervention(target, 'rtss', rtss_coverage, correlations)
