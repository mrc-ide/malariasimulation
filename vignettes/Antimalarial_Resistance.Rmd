...
simparams_clin_treatment <- set_drugs(parameters = simparams, drugs = list(AL_params_falciparum))
...
simparams <- set_drugs(parameters = simparams, drugs = list(SP_AQ_params_falciparum))
...
simulation_parameters$base |>
  set_drugs(drugs = list(AL_params_falciparum)) |>
