...
# Add a legend:
legend(legend = c(expression("M"["Tot"]), "MDA", "Peak"),
       #x = (sim_length * 0.83), y = 61000,
       x = (sim_length * 0.01), y = max(noint_output$mosq_total)*1.05,
