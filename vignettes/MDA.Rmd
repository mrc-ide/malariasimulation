...
plot(x = mda_output$timestep,
     y = mda_output$n_detect_730_3650/mda_output$n_age_730_3650,
     xlab = "Time (days)",
...
lines(x = noint_output$timestep,
     y = noint_output$n_detect_730_3650/noint_output$n_age_730_3650,
     col = cols[4])
...
# Plot malaria prevalence in 2-10 years through time:
plot(x = smc_output$timestep, y = smc_output$n_detect_730_3650/smc_output$n_age_730_3650,
     xlab = "Time (days)", 
     ylab = expression(paste(italic(Pf),"PR"[2-10])), cex = 0.8,
     ylim = c(0, 1), type = "l", lwd = 2, xaxs = "i", yaxs = "i",
     col = cols[3])
