...
# amodiaquine (SP-AQ)
mdaparams <- set_drugs(mdaparams, list(SP_AQ_params_falciparum))
...
smcparams <- set_drugs(smcparams, list(SP_AQ_params_falciparum))
