...
These outputs can then be visualised, such as the population changes in states. Another key output is the prevalence of detectable infections between the ages of 2-10 (*Pf*PR~2-10~), which can be obtained by dividing `n_detect_730_3650` by `n_age_730_3650`.
...
test_sim$PfPR2_10 <- test_sim$n_detect_730_3650/test_sim$n_age_730_3650
...
# Calculate Pf PR 2-10
test_sim_eq$PfPR2_10 <- test_sim_eq$n_detect_730_3650/test_sim_eq$n_age_730_3650
