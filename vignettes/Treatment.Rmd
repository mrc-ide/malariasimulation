...
1.  `AL_params_falciparum`: artemether-lumefantrine (AL)
2.  `DHA_PQP_params_falciparum`: dihydroartemisinin and piperaquine (DHA-PQP)
3.  `SP_AQ_params_falciparum`: sulfadoxine-pyrimethamine and amodiaquine (SP-AQ)
...
P_matrix <- lapply(list(AL_params_falciparum, DHA_PQP_params_falciparum, SP_AQ_params_falciparum), function(x){
...
drug_params <- set_drugs(simparams, list(AL_params_falciparum, DHA_PQP_params_falciparum))
