...
lsm_rate_beta: the default is -0.2 which achieves the reduced recruitment equilibrium (the proportion of mosquitoes recruited to the susceptible cohort as defined by lsm_new_eqm) after about 30 days (if lsm_rate_alpha is 6). The range to try is suggested to be between -0.5 (giving a week from implementation to new level of adult susceptible mosquitoes - a fraction of the number in the absence of LSM) and -0.1 (giving about 2 months between implementation and the new equilibrium)
