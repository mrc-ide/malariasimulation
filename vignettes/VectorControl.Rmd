...
```{r}
# Plotting functions
plot_incidence <- function(output) {
  plot(x = output$timestep, y = output$n_inc_clinical_730_3650/output$n_730_3650, type = 'l',
       xlab = 'Timestep (days)', ylab = 'Clinical incidence',
       xaxs = "i", yaxs = "i", bty = "l")
}
...
add_intervention_lines(plot_incidence(output), bednet_events)
```
...
add_intervention_lines(plot_incidence(output), spraying_events)
```
