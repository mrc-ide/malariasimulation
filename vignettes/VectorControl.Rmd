...
add_intervention_lines <- function(plot, events) {
  plot
  abline(v = events$timestep, col = cols[7], lty = 2, lwd = 2.5)
}
```
...
plot(x = output$timestep, y = output$prop_use_net, type = 'l', col = cols[1],
     xlab = 'Timestep (days)', ylab = 'Proportion using bednets',
     xaxs = "i", yaxs = "i", bty = "l")
```
