...
We can do the same for LSM with the individual_mosquitoes parameter set to FALSE ...
This functionality is not yet operatable for the individual mosquito version of the model.
...
habitat_managementparams <- set_habitat_management(
  ...
  larvi_min = matrix(0.2,nrow=1,ncol=3),
  lsm_rate = matrix(4,nrow=1,ncol=3),
  deprec_param = matrix(-1,nrow=1,ncol=3)
)
